...
The friction Reynolds number was computed from the DNS simulations for each one of the three considered cases. By comparing these results with an an existed approximation valid for fully developed turbulent flows existed in Ref.~\cite{pope} we could notice a delay in the development of the turbulence caused by the varying viscosity. This was expected and makes sense indeed ...
