...
Unfortunately, it was not possible to run Cases II and III for the same long as Case I, thus the results for these simulations did not reach statistically stability in Region III. Still though, the parameter \(C=1.162\) has already well played its role for all three cases in Region II.
